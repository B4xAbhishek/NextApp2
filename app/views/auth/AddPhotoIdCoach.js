...
import { View, Keyboard, TouchableOpacity, Text, ScrollView, SafeAreaView, Image, KeyboardAvoidingView, ImageBackground, Alert } from 'react-native';
import * as Progress from 'react-native-progress';
import ImagePicker from 'react-native-image-crop-picker';
...
export default function AddPhotoIdCoach({
    navigation
}) {
    const [avatar, setAvatar] = useState('')
    const [avatarCerti, setAavatarCerti] = useState('')

    const pickSingle = (cropit, circular = false, isFrom) => {
        Alert.alert(
            isFrom === 'ava' ? 'PHOTO ID' : 'COACHING CERTIFICATE',
            'Pick from',
            [
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.base }}>
            <View style={{ flex: 1, backgroundColor: Colors.base, }} >
                <TouchableOpacity style={{ marginHorizontal: 32, }} onPress={() => navigation.goBack()}>
                    <Image style={{
                        width: wide * 0.1, height: wide * 0.1,
                        marginTop: 24, borderRadius: wide * 0.03, borderWidth: 1, borderColor: Colors.borderColor
                    }} source={require('../../Images/back_ico.png')} />
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginVertical: wide * 0.1, justifyContent: 'space-evenly' }}>
                        <TouchableOpacity onPress={() => pickSingle(true, false, 'ava')}>
                            {
                                avatar === ''
                                    ?
                                    <Image source={require('../../Images/Placeholder_PhotoId.png')} resizeMode='cover' />
                        ...
                        <TouchableOpacity style={{ marginTop: 30 }} onPress={() => pickSingle(true, false, 'certi')}>
                            {
                                avatarCerti === ''
                                    ?
                                    <View style={{ justifyContent: 'center', alignItems: 'center', paddingVertical: 10 }}>
